...
public class CoolQ {
  ...
  private JSONObject sendApiMessage(ApiEnum action, JSONObject params, int maxSize) {
    ...
    logger.info("{} SEND API   {} {} Result:{}", selfId, action.getDesc(), params,
        retJson.toString());
    return retJson;
  }
  ...
  public ApiData<MessageData> sendPrivateMsg(long user_id, String message, boolean auto_escape) {
    ...
    ApiData<MessageData> result = sendApiMessage(action, params)
  ...
  public static void main(String[] args) throws UnsupportedEncodingException {
    ...
    params.put("message", URLEncoder.encode("29.9  买1送1同款\n" +
            "    			广州酒家乳酸菌小口袋面包整箱680g\n" +
            "    			 ￥gnRtYztdu6k￥ [CQ:image,file=4E7D3113134336E146537629AD5693FD.jpg,url=https://gchat.qpic.cn/gchatpic_new/1071893649/3915239590-2736407206-4E7D3113134336E146537629AD5693FD/0?vuin=779721310&amp;term=2]",
        "UTF-8"));
    ...
    System.out.println(
        (HttpUtil.httpMethodPost("http://www.alinkeji.com:5700/send_group_msg", paramsMap)));
  }
  ...
  public ApiData<MessageData> sendMsg(String message_type, long user_id, long group_id,
      long discuss_id, String message, boolean auto_escape) {
  ...
  public ApiRawData setGroupAnonymousBan(long group_id, CQGroupAnonymous cqGroupAnonymous,
      boolean duration) {
  ...
  public ApiData<LoginInfoData> getLoginInfo() {
    ...
    ApiData<LoginInfoData> result = sendApiMessage(action, null)
  ...
  public ApiData<StrangerInfoData> getStrangerInfo(long user_id, boolean no_cache) {
    ...
    ApiData<StrangerInfoData> result = sendApiMessage(action, null)
  ...
  public ApiListData<FriendData> getFriendList() {
    ...
    ApiListData<FriendData> result = sendApiMessage(action, null, maxSize)
  ...
  public ApiListData<GroupData> getGroupList() {
    ...
    ApiListData<GroupData> result = sendApiMessage(action, null)
  ...
  public ApiData<GroupMemberInfoData> getGroupMemberInfo(long group_id, long user_id,
    ...
    ApiData<GroupMemberInfoData> result = sendApiMessage(action, params)
  ...
  public ApiData<CookiesData> getCookies(String domain) {
    ...
    ApiData<CookiesData> result = sendApiMessage(action, params)
  ...
  public ApiData<CsrfTokenData> getCsrfToken() {
    ...
    ApiData<CsrfTokenData> result = sendApiMessage(action, null)
  ...
  public ApiData<CredentialsData> getCredentials() {
    ...
    ApiData<CredentialsData> result = sendApiMessage(action, null)
  ...
  public ApiData<FileData> getRecord(String file, String out_format, boolean full_path) {
    ...
    ApiData<FileData> result = sendApiMessage(action, params)
  ...
  public ApiData<BooleanData> canSendImage() {
    ...
    ApiData<BooleanData> result = sendApiMessage(action, null)
  ...
  public ApiData<CQStatus> getStatus() {
    ...
    ApiData<CQStatus> result = sendApiMessage(action, null)
        .toJavaObject(new TypeReference<ApiData<CQStatus>>() {
        });
    return result;
  }
  ...
  public ApiData<VersionInfoData> getVersionInfo() {
    ...
    ApiData<VersionInfoData> result = sendApiMessage(action, null)
