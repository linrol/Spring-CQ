...
public class WebApiController {
  ...
  public String sendpMsg(long self_id, String message_type, long user_id, long group_id,
      long discuss_id, String message, Boolean auto_escape)
      throws IOException, InterruptedException {
    Global.robots.get(self_id)
        .sendMsg(message_type, user_id, group_id, discuss_id, message, auto_escape);
    return "ok";
  }
